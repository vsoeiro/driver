...
Uploads a small file (up to 4MB) directly to OneDrive.
...
|----------|--------|-------------|
| `/me/drive/root:/{filename}:/content` | PUT | Upload to root |
| `/me/drive/items/{folder_id}:/{filename}:/content` | PUT | Upload to folder |
