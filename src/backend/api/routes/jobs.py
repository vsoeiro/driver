...
@router.post(
    "/metadata-update", response_model=Job, status_code=status.HTTP_201_CREATED
)
...
@router.post(
    "/apply-metadata-recursive", response_model=Job, status_code=status.HTTP_201_CREATED
)
...
@router.post(
    "/comics/extract-library",
    response_model=JobExtractLibraryComicAssetsResponse,
    status_code=status.HTTP_201_CREATED,
)
...
@router.post(
    "/{job_id}/reprocess", response_model=Job, status_code=status.HTTP_201_CREATED
)
...
@router.get(
    "/{job_id}/attempts",
    response_model=list[JobAttempt],
